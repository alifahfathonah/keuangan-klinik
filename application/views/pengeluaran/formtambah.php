    ...
    <div class="row">
      ...
      <div class="col-md-12">
        ...
        <div class="card card-primary">
          ...
          <form method="POST" enctype="multipart/form-data" action="<?php echo site_url('Pengeluaran/simpan') ?>" role="form">
            <div class="card-body">
            ...
            <div class="card-footer">
              ...
              <button type="button" onClick="location.href=('<?php echo site_url('pengeluaran') ?>')" class="btn btn-danger">Cancel</button>
            </div>
    ...
    <div class="modal-content">
      <div class="modal-header">
        ...
        <div class="box-body table-responsive">
          <h1 class="modal-title" id="myModalLabel">INPUT ITEM PENGELUARAN</h1>
          <br><br>
