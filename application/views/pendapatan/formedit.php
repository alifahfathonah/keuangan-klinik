      ...
      <div class="col-md-12">
        ...
        <div class="card card-primary">
          <div class="card-header">
            <h3 class="card-title">Edit Data Pendapatan</h3>
          </div>
          <!-- /.card-header -->
          <!-- form start -->
        
          <form method="POST" enctype="multipart/form-data" action="<?php echo site_url('pendapatan/update') ?>" role="form">
            <div class="card-body">
              <div class="form-group">
                <!-- <label for="exampleInputEmail1">Kode Saldo</label> -->
                <input type="text" class="form-control" value="<?php echo $kdt ?>" name="kdtran" id="exampleInputEmail1">
              </div>
              <div class="form-group">
            ...
            <div class="card-footer">
              ...
              <button type="button" onClick="location.href=('<?php echo site_url('pendapatan') ?>')" class="btn btn-danger">Cancel</button>
            </div>
      ...
      <div class="modal-header">
        ...
        <div class="box-body table-responsive">
          ...
          <table class="table table-bordered table-striped table-hover" id="datatiket">
            ...
            <tr>
              <td>Jumlah</td>
              <td><input type="text" value="<?php echo $jml ?>" class="form-control" name="jumlah"></td>
            </tr>
            <tr>
              <td></td>
              <td>
                <input type="text" value="<?php echo $kds ?>" class="form-control" name="kdsal">
                <!-- <input type="text" value="<?php echo $sdak ?>" class="form-control" name="sda"></td> -->
            </tr>
