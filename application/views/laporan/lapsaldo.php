	   	...
	   	<tbody>
	   		<?php 
	   			...
	   			foreach ($tampil->result_array() as $i) {
	   				$no++;	
	   			$totsemua1 = $totsemua1+$i['TOTPEN'];
	   			$totsemua2 = $totsemua2+$i['TOTPENG'];

	   			$totpen = $i['TOTPEN'] - $i['TOTPENG'];
	   			$totpeng = $i['TOTPENG'] - $i['TOTPEN'];
//Laba
...
//Rugi
	   		...
	   		<tr>
	   			...
	   			<td align="right"><?php echo "Rp.".number_format($i['TOTPEN']) ?></td>
	   			<td align="right"><?php echo "Rp.".number_format($i['TOTPENG']) ?></td>
	   		</tr>
	   		<tr>
	   	<?php } ?>
	   	<tr>
	   		<td colspan="4" style="font-weight: bold;text-align: center;">Total Semua</td>
	   ...
	   <table align="center" width="100%">
	   	...
	   	<tr>
	   		...
	   		<td><?php echo "Rp ". number_format($i['saldoakhir']); ?></td>
	   	</tr>
	   	<tr>
